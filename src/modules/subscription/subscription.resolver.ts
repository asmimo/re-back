...
export class SubscriptionResolver {
  ...
  async createSubscription(@Args() dto: CreateSubscriptionDTO): Promise<Subscription> {
    return this.subscriptionService.createSubscription(dto)
  }

  @Query(() => Subscription)
  async getSubscription(@Args() { id }: IdDto, @Info() info: GraphQLResolveInfo): Promise<Subscription> {
  ...
  @Mutation(() => Subscription)
  async updateSubscription(@Args() dto: UpdateSubscriptionDTO): Promise<Subscription> {
